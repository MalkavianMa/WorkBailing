...
{
    /// <summary>
    /// 济南职工统筹 Source:南部山区 from:历下区
    /// </summary>
    public class JNDWInterfaceModel_ZGTC : IPayCompanyInterface
    {
        //医保个人信息 
        ...
        public void OutNetworkSettle(OutPayParameter para)
        {
            ...
            try
            {
                ...
                handelModel.InitZGMZ(outReimPara.RegInfo.CantonCode, outReimPara.CommPara.OutNetworkSettleId.ToString(), outReimPara.PatInfo.PatName, dicPatInfo["xb"],
        ...
        public void CancelInNetworkSettle(InPayParameter para)
        {
            ...
            InterfaceInit();
            LogManager.Debug("取消朱元结算 住院结算号：" + settleNo + " 住院号:" + patInHosCode + "");
