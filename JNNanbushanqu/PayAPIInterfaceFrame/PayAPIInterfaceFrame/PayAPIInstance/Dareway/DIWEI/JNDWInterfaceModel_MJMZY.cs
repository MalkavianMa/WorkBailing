...
{
    /// <summary>
    /// 济南居民住院 Source:南部山区 from:历下区
    /// </summary>
    public class JNDWInterfaceModel_MJMZY : IPayCompanyInterface
    {
        //医保个人信息 
        ...
        public void OutNetworkRegister(OutPayParameter para)
        {
            ...
            throw new Exception("该类别为住院,门诊业务不可用!");
            //outReimPara = para;
        ...
        public void InNetWorkReadCard(InPayParameter para)
        {
            ...
            //判断有卡无卡
            // frmCARD frmCard = new frmCARD();
            string quickIDnumber = inReimPara.PatInfo.IDNo;
            ...
            {
                MessageBox.Show("提示：该患者人员类别属于职工，但住院信息中费别为居民，请取消操作并调整患者住院费别为职工！");
        ...
        public void InNetworkPreSettle(InPayParameter para)
        {
            ...
            {
                throw new Exception("inReimPara.Details.Count无数据");
            }
