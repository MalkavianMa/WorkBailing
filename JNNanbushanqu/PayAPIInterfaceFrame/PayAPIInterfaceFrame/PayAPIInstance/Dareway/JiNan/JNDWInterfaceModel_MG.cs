...
namespace PayAPIInstance.Dareway.JiNan
{
    ...
    /// 职工和居民门规
    /// </summary>
    public class JNDWInterfaceModel_MG : IPayCompanyInterface
    {
        //医保个人信息 
        ...
        /// <summary>
        ///  使用账户类型;0 不使用,1银行卡,2 cpu 卡，3，济南医保卡，5，普通人员无卡门规结算
        /// </summary>
        ...
        public void OutNetworkSettle(OutPayParameter para)
        {
            ...
            handelModel.InitMZMG(outReimPara.RegInfo.CantonCode, "4", outReimPara.RegInfo.MemberNo, outReimPara.RegInfo.NetPatName,
                                dicPatInfo["xb"], outReimPara.RegInfo.OutNetworkSettleId.ToString(), DateTime.Now.ToString("yyyy-MM-dd"),//"001", 
