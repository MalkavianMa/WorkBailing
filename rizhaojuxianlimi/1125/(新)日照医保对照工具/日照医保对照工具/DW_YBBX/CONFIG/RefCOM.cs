...
namespace DW_YBBX
{
    ...
    public class RefCOM : IDisposable
    {
        ...
        /// <param name="ObjList">参数列表</param>
        /// <returns></returns>
        public DateTime ExeFuncReDatetime(string FuncName, Object[] ObjList)
        {
            return Convert.ToDateTime(tp.InvokeMember(FuncName, BindingFlags.InvokeMethod, null, COMObj, ObjList));
        }
