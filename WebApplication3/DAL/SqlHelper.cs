...
namespace DAL
{
    ...
    public sealed partial class SqlHelper
    {
       ...
       // public static string Connstring= ConfigurationManager.ConnectionStrings["BookShopconnStr"].ToString();
        public static string Connstring = ""; //" Data Source=.;Initial Catalog=GreenGrocer;Integrated Security=true;";
       ...
       // public static string Connstring=SqlHelper.Connstring;
      ...
      //  public static string Connstring { get; set; }
        ...
        {
            return ExecuteNonQuery(Connstring, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteNonQuery(Connstring, commandType, commandText, parms);
        }
        ...
        {
            return ExecuteScalar<T>(Connstring, commandText, parms);
        }
        ...
        {
            return ExecuteScalar(Connstring, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteScalar(Connstring, commandType, commandText, parms);
        }
        ...
        {
            return ExecuteDataReader(Connstring, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteDataReader(Connstring, commandType, commandText, parms);
        }
        #endregion
        ...
        {
            return ExecuteDataRow(Connstring, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteDataRow(Connstring, commandType, commandText, parms);
        }
        ...
        {
            return ExecuteDataTable(Connstring, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteDataSet(Connstring, commandType, commandText, parms).Tables[0];
        }
        ...
        {
            return ExecuteDataSet(Connstring, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteDataSet(Connstring, commandType, commandText, parms);
        }
        ...
        {
            BatchDelete(Connstring, sql, batchSize, interval);
        }
        ...
        {
            BatchUpdate(Connstring, sql, batchSize, interval);
        }
